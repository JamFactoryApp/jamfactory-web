...
export class QueueSongComponent implements OnInit {
  ...
  constructor(private queueService: QueueService, private colorDiffService: ColorService) {}

  ngOnInit(): void {
    console.log(this.songVoted);
  }
  ...
  getImgColor(): void {
    ...
    const col2 = this.colorDiffService.highestDiff(palette, col);
